...
public class Main {
    ...
    public static void main(String[] args) {
        //numberToWords(reverse(366));
        numberToWords(22);
        //System.out.println(reverse(22));
...
//            NOTE: Do not add a main method to the solution code.
    public static void numberToWords(int number)
    {
        ...
        int zeroAmount = getDigitCount(number) - getDigitCount(reversedNumber);
    ...
    public static int reverse(int reversedNum)
    {
        int reverse = 0;
        int lastDigit;
