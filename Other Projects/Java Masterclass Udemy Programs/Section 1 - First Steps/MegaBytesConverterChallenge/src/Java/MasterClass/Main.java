...
//    If the parameter kiloBytes is less than 0 then print the text "Invalid Value".
    public static void printMegaBytesAndKiloBytes(int kiloBytes)
    {
        if (kiloBytes < 0)
        {
            ...
            {
            // 1 MB = 1024 KB
            double megaBytes = kiloBytes / 1024.00;
            int subtractedKB = (int) ((megaBytes - (int) megaBytes) * 1024);

            System.out.println(kiloBytes + " KB = " + (int) megaBytes + " MB and " + subtractedKB + " KB");
            }
    }
//
//
