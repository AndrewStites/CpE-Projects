...
public class MoveBlueEllipse extends Application {
    double mouse_x = 0.0;
    double mouse_y = 0.0;
    double circle_x = 10;
    double circle_y = 14;
    ...
    //move circle
    public void moveX(MouseEvent e, Canvas canvas) {
    ...
    public void moveY(MouseEvent e, Canvas canvas) {
	            double change_y = e.getSceneY() - this.mouse_y;
